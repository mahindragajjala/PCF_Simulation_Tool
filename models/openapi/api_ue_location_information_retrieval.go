...
type UELocationInformationRetrievalAPI struct {
}

// Get /nudm-uecm/v1/:ueId/registrations/location
// retrieve the target UE's location information 
func (api *UELocationInformationRetrievalAPI) GetLocationInfo(c *gin.Context) {
