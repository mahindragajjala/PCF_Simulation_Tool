...
type PpData struct {
	...
	ExpectedUeBehaviourExtension *ExpectedUeBehaviourExtension `json:"expectedUeBehaviourExtension,omitempty"`
	...
	DnnSnssaiSpecificGroup *DnnSnssaiSpecificGroup `json:"dnnSnssaiSpecificGroup,omitempty"`

	MbsAssistanceInfo MbsAssistanceInfo `json:"mbsAssistanceInfo,omitempty"`

	AppSpecificExpectedUeBehaviour *AppSpecificExpectedUeBehaviour `json:"appSpecificExpectedUeBehaviour,omitempty"`
