...
func (a *NonUEN2MessagesSubscriptionsCollectionDocumentApiService) NonUeN2InfoSubscribe(ctx context.Context, nonUeN2InfoSubscriptionCreateData openapi.NonUeN2InfoSubscriptionCreateData) (openapi.NonUeN2InfoSubscriptionCreatedData, *http.Response, error) {
	var (
		...
		localVarReturnValue  openapi.NonUeN2InfoSubscriptionCreatedData
	)
