...
func (a *NonUEN2MessagesCollectionDocumentApiService) NonUeN2MessageTransfer(ctx context.Context, request openapi.NonUeN2MessageTransferRequest) (openapi.N2InformationTransferRspData, *http.Response, error) {
	var (
		...
		localVarReturnValue  openapi.N2InformationTransferRspData
	)
	...
	case 400:
		var v openapi.N2InformationTransferError
