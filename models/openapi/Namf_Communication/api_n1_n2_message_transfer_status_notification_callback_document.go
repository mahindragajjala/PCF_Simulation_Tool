...
*/
func (a *N1N2MessageTransferStatusNotificationCallbackDocumentApiService) N1N2TransferFailureNotification(ctx context.Context, n1N2MessageTransferNotificationUrl string, request openapi.N1N2MsgTxfrFailureNotification) (*http.Response, error) {
	var (
