...
func (a *N1MessageNotifyCallbackDocumentApiService) N1MessageNotify(ctx context.Context, n1MessageNotificationUrl string, request openapi.N1MessageNotify) (*http.Response, error) {
	var (
