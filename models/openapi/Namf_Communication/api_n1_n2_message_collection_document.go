...
func (a *N1N2MessageCollectionDocumentApiService) N1N2MessageTransfer(ctx context.Context, ueContextId string, request openapi.N1N2MessageTransferRequest) (openapi.N1N2MessageTransferRspData, *http.Response, error) {
	var (
		...
		localVarReturnValue  openapi.N1N2MessageTransferRspData
	)
	...
	case 404:
		...
		return localVarReturnValue, localVarHttpResponse, apiError
	case 409:
		var v openapi.N1N2MessageTransferError
		err = openapi.Deserialize(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
		if err != nil {
			apiError.ErrorStatus = err.Error()
			return localVarReturnValue, localVarHttpResponse, apiError
