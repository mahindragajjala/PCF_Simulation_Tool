...
func (a *IndividualSubscriptionDocumentApiService) AMFStatusChangeSubscribeModfy(ctx context.Context, subscriptionId string, subscriptionData openapi.SubscriptionData) (openapi.SubscriptionData, *http.Response, error) {
	var (
		...
		localVarReturnValue  openapi.SubscriptionData
	)
