...
func (a *NFInstancesStoreApiService) SearchNFInstances(ctx context.Context, targetNfType openapi.NfType, requesterNfType openapi.NfType, localVarOptionals *SearchNFInstancesParamOpts) (openapi.SearchResult, *http.Response, error) {
	var (
		...
		localVarReturnValue  openapi.SearchResult
	)
	...
	fmt.Println("ctx, a.client.cfg, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFormFileName, localVarFileName, localVarFileBytes",ctx, a.client.cfg, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFormFileName, localVarFileName, localVarFileBytes)
