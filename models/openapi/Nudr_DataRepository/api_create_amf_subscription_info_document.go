...
func (a *CreateAMFSubscriptionInfoDocumentApiService) CreateAMFSubscriptions(ctx context.Context, ueId string, subsId string, amfSubscriptionInfo []openapi.AmfSubscriptionInfo) (*http.Response, error) {
	var (
