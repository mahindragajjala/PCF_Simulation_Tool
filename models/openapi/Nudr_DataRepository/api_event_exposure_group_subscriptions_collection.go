...
@return openapi.EeSubscription
*/

func (a *EventExposureGroupSubscriptionsCollectionApiService) CreateEeGroupSubscriptions(ctx context.Context, ueGroupId string, eeSubscription openapi.EeSubscription) (openapi.EeSubscription, *http.Response, error) {
	var (
		...
		localVarReturnValue  openapi.EeSubscription
	)
...
func (a *EventExposureGroupSubscriptionsCollectionApiService) QueryEeGroupSubscriptions(ctx context.Context, ueGroupId string, localVarOptionals *QueryEeGroupSubscriptionsParamOpts) ([]openapi.EeSubscription, *http.Response, error) {
	var (
