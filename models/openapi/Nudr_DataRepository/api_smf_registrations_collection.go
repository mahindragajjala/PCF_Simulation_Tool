...
func (a *SMFRegistrationsCollectionApiService) QuerySmfRegList(ctx context.Context, ueId string, localVarOptionals *QuerySmfRegListParamOpts) ([]openapi.SmfRegistration, *http.Response, error) {
	var (
