...
func (a *SMFRegistrationDocumentApiService) CreateSmfContextNon3gpp(ctx context.Context, ueId string, pduSessionId int32, localVarOptionals *CreateSmfContextNon3gppParamOpts) (*http.Response, error) {
	...
	if localVarOptionals != nil && localVarOptionals.SmfRegistration.IsSet() {
		localVarOptionalSmfRegistration, localVarOptionalSmfRegistrationok := localVarOptionals.SmfRegistration.Value().(openapi.SmfRegistration)
...
@return openapi.SmfRegistration
*/
...
func (a *SMFRegistrationDocumentApiService) QuerySmfRegistration(ctx context.Context, ueId string, pduSessionId string, localVarOptionals *QuerySmfRegistrationParamOpts) (openapi.SmfRegistration, *http.Response, error) {
	var (
		...
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  openapi.SmfRegistration
	)
