...
func (a *AuthEventDocumentApiService) QueryAuthenticationStatus(ctx context.Context, ueId string, localVarOptionals *QueryAuthenticationStatusParamOpts) (openapi.AuthEvent, *http.Response, error) {
	var (
		...
		localVarReturnValue  openapi.AuthEvent
	)
