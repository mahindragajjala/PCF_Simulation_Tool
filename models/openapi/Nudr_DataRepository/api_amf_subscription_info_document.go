...
func (a *AmfSubscriptionInfoDocumentApiService) ModifyAmfSubscriptionInfo(ctx context.Context, ueId string, subsId string, patchItem []openapi.PatchItem) (*http.Response, error) {
	var (
