 ...
 * @param ueId
 * @param subsId
@return []openapi.AmfSubscriptionInfo
*/

func (a *QueryAMFSubscriptionInfoDocumentApiService) GetAmfSubscriptionInfo(ctx context.Context, ueId string, subsId string) ([]openapi.AmfSubscriptionInfo, *http.Response, error) {
	var (
		...
		localVarReturnValue  []openapi.AmfSubscriptionInfo
	)
