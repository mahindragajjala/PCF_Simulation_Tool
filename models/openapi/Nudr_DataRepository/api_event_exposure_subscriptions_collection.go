...
func (a *EventExposureSubscriptionsCollectionApiService) CreateEeSubscriptions(ctx context.Context, ueId string, eeSubscription openapi.EeSubscription) (openapi.EeSubscription, *http.Response, error) {
	var (
...
func (a *EventExposureSubscriptionsCollectionApiService) Queryeesubscriptions(ctx context.Context, ueId string, localVarOptionals *QueryeesubscriptionsParamOpts) ([]openapi.EeSubscription, *http.Response, error) {
	var (
