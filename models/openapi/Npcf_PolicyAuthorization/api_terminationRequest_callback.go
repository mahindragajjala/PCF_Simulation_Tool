...
func (a *PolicyAuthorizationTerminateRequestApiService) PolicyAuthorizationTerminateRequest(ctx context.Context, afNotifyUri string, request openapi.TerminationInfo) (*http.Response, error) {
	var (
