...
func (a *PolicyAuthorizationEventNotificationApiService) PolicyAuthorizationEventNotification(ctx context.Context, afNotifyUri string, request openapi.EventsNotification) (*http.Response, error) {
	var (
