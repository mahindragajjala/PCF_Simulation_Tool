...
/*
 ...
 @return openapi.UpdateEventsSubscResponse
*/

func (a *EventsSubscriptionDocumentApiService) UpdateEventsSubsc(ctx context.Context, appSessionId string, eventsSubscReqData openapi.EventsSubscReqData) (openapi.UpdateEventsSubscResponse, *http.Response, error) {
	var (
		...
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  openapi.UpdateEventsSubscResponse
	)
