...
type UECMRegistrationInfoRetrievalAPI struct {
}

// Get /nudm-uecm/v1/:ueId/registrations
// retrieve UE registration data sets 
func (api *UECMRegistrationInfoRetrievalAPI) GetRegistrations(c *gin.Context) {
