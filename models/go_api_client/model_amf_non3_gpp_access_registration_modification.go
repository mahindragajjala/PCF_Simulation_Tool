...
type _AmfNon3GppAccessRegistrationModification AmfNon3GppAccessRegistrationModification
...
func (o *AmfNon3GppAccessRegistrationModification) UnmarshalJSON(data []byte) (err error) {
	...
	varAmfNon3GppAccessRegistrationModification := _AmfNon3GppAccessRegistrationModification{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAmfNon3GppAccessRegistrationModification)

	if err != nil {
		return err
	}

	*o = AmfNon3GppAccessRegistrationModification(varAmfNon3GppAccessRegistrationModification)
