...
type _AuthorizationUeId AuthorizationUeId
...
func (o *AuthorizationUeId) UnmarshalJSON(data []byte) (err error) {
	...
	varAuthorizationUeId := _AuthorizationUeId{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAuthorizationUeId)

	if err != nil {
		return err
	}

	*o = AuthorizationUeId(varAuthorizationUeId)
