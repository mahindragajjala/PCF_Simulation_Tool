...
type PpData struct {
	...
	ExpectedUeBehaviourExtension NullableExpectedUeBehaviourExtension `json:"expectedUeBehaviourExtension,omitempty"`
	...
	DnnSnssaiSpecificGroup NullableDnnSnssaiSpecificGroup `json:"dnnSnssaiSpecificGroup,omitempty"`
	MbsAssistanceInfo *MbsAssistanceInfo `json:"mbsAssistanceInfo,omitempty"`
	AppSpecificExpectedUeBehaviour NullableAppSpecificExpectedUeBehaviour `json:"appSpecificExpectedUeBehaviour,omitempty"`
	SliceUsageControlInfos []SliceUsageControlInfo `json:"sliceUsageControlInfos,omitempty"`
}
...
func (o *PpData) GetExpectedUeBehaviourExtension() ExpectedUeBehaviourExtension {
	if o == nil || IsNil(o.ExpectedUeBehaviourExtension.Get()) {
...
func (o *PpData) GetDnnSnssaiSpecificGroup() DnnSnssaiSpecificGroup {
	if o == nil || IsNil(o.DnnSnssaiSpecificGroup.Get()) {
...
func (o *PpData) GetMbsAssistanceInfo() MbsAssistanceInfo {
	if o == nil || IsNil(o.MbsAssistanceInfo) {
...
func (o *PpData) GetAppSpecificExpectedUeBehaviour() AppSpecificExpectedUeBehaviour {
	if o == nil || IsNil(o.AppSpecificExpectedUeBehaviour.Get()) {
...
func (o *PpData) GetSliceUsageControlInfos() []SliceUsageControlInfo {
	if o == nil || IsNil(o.SliceUsageControlInfos) {
...
func (o PpData) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.SliceUsageControlInfos) {
