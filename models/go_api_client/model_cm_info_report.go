...
type _CmInfoReport CmInfoReport
...
func (o *CmInfoReport) UnmarshalJSON(data []byte) (err error) {
	...
	varCmInfoReport := _CmInfoReport{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCmInfoReport)

	if err != nil {
		return err
	}

	*o = CmInfoReport(varCmInfoReport)
