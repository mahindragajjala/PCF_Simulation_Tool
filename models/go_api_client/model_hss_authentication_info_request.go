...
type _HssAuthenticationInfoRequest HssAuthenticationInfoRequest
...
func (o *HssAuthenticationInfoRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varHssAuthenticationInfoRequest := _HssAuthenticationInfoRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varHssAuthenticationInfoRequest)

	if err != nil {
		return err
	}

	*o = HssAuthenticationInfoRequest(varHssAuthenticationInfoRequest)
