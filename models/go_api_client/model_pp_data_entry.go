...
type PpDataEntry struct {
	...
	EcsAddrConfigInfoPerPlmn *map[string][]EcsAddrConfigInfo `json:"ecsAddrConfigInfoPerPlmn,omitempty"`
...
func (o *PpDataEntry) GetEcsAddrConfigInfoPerPlmn() map[string][]EcsAddrConfigInfo {
	if o == nil || IsNil(o.EcsAddrConfigInfoPerPlmn) {
...
func (o PpDataEntry) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.EcsAddrConfigInfoPerPlmn) {
