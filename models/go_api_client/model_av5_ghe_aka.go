...
func (o *Av5GHeAka) UnmarshalJSON(data []byte) (err error) {
	...
	varAv5GHeAka := _Av5GHeAka{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAv5GHeAka)

	if err != nil {
		return err
	}

	*o = Av5GHeAka(varAv5GHeAka)
