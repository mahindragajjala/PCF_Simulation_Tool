...
type _FailedMonitoringConfiguration FailedMonitoringConfiguration
...
func (o *FailedMonitoringConfiguration) UnmarshalJSON(data []byte) (err error) {
	...
	varFailedMonitoringConfiguration := _FailedMonitoringConfiguration{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varFailedMonitoringConfiguration)

	if err != nil {
		return err
	}

	*o = FailedMonitoringConfiguration(varFailedMonitoringConfiguration)
