...
type _AuthUpdateNotification AuthUpdateNotification
...
func (o *AuthUpdateNotification) UnmarshalJSON(data []byte) (err error) {
	...
	varAuthUpdateNotification := _AuthUpdateNotification{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAuthUpdateNotification)

	if err != nil {
		return err
	}

	*o = AuthUpdateNotification(varAuthUpdateNotification)
