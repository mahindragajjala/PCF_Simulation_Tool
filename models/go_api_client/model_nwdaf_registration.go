...
type _NwdafRegistration NwdafRegistration
...
func (o *NwdafRegistration) UnmarshalJSON(data []byte) (err error) {
	...
	varNwdafRegistration := _NwdafRegistration{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varNwdafRegistration)

	if err != nil {
		return err
	}

	*o = NwdafRegistration(varNwdafRegistration)
