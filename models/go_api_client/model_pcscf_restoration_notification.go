...
type _PcscfRestorationNotification PcscfRestorationNotification
...
func (o *PcscfRestorationNotification) UnmarshalJSON(data []byte) (err error) {
	...
	varPcscfRestorationNotification := _PcscfRestorationNotification{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPcscfRestorationNotification)

	if err != nil {
		return err
	}

	*o = PcscfRestorationNotification(varPcscfRestorationNotification)
