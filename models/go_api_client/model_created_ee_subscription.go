...
func (o *CreatedEeSubscription) GetCurrentStatusNotAvailableList() []EventType {
	if o == nil || IsNil(o.CurrentStatusNotAvailableList) {
		var ret []EventType
		return ret
	}
...
// SetCurrentStatusNotAvailableList gets a reference to the given []EventType and assigns it to the CurrentStatusNotAvailableList field.
...
func (o CreatedEeSubscription) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.CurrentStatusNotAvailableList) {
		toSerialize["currentStatusNotAvailableList"] = o.CurrentStatusNotAvailableList
	}
	return toSerialize, nil
}

func (o *CreatedEeSubscription) UnmarshalJSON(data []byte) (err error) {
	...
	err = decoder.Decode(&varCreatedEeSubscription)
