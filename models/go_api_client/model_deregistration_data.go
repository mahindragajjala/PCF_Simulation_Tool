...
type _DeregistrationData DeregistrationData
...
func (o *DeregistrationData) UnmarshalJSON(data []byte) (err error) {
	...
	varDeregistrationData := _DeregistrationData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDeregistrationData)

	if err != nil {
		return err
	}

	*o = DeregistrationData(varDeregistrationData)
