...
type _NwdafRegistrationInfo NwdafRegistrationInfo
...
func (o *NwdafRegistrationInfo) UnmarshalJSON(data []byte) (err error) {
	...
	varNwdafRegistrationInfo := _NwdafRegistrationInfo{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varNwdafRegistrationInfo)

	if err != nil {
		return err
	}

	*o = NwdafRegistrationInfo(varNwdafRegistrationInfo)
