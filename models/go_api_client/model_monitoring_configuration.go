...
func (o *MonitoringConfiguration) GetMonitoringSuspension() MonitoringSuspension {
	if o == nil || IsNil(o.MonitoringSuspension) {
...
func (o MonitoringConfiguration) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.MonitoringSuspension) {
		toSerialize["monitoringSuspension"] = o.MonitoringSuspension
	}
	return toSerialize, nil
}

func (o *MonitoringConfiguration) UnmarshalJSON(data []byte) (err error) {
	...
	err = decoder.Decode(&varMonitoringConfiguration)
