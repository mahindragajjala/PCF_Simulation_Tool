...
func (o *RgAuthCtx) UnmarshalJSON(data []byte) (err error) {
	...
	varRgAuthCtx := _RgAuthCtx{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRgAuthCtx)

	if err != nil {
		return err
	}

	*o = RgAuthCtx(varRgAuthCtx)
