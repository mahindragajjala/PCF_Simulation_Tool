...
type _LossConnectivityReport LossConnectivityReport
...
func (o *LossConnectivityReport) UnmarshalJSON(data []byte) (err error) {
	...
	varLossConnectivityReport := _LossConnectivityReport{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varLossConnectivityReport)

	if err != nil {
		return err
	}

	*o = LossConnectivityReport(varLossConnectivityReport)
