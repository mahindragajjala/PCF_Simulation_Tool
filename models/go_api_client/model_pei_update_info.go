...
type PeiUpdateInfo struct {
	...
	Pei string `json:"pei" validate:"regexp=^(imei-[0-9]{15}|imeisv-[0-9]{16}|mac((-[0-9a-fA-F]{2}){6})(-untrusted)?|eui((-[0-9a-fA-F]{2}){8})|.+)$"`
}
...
func (o *PeiUpdateInfo) UnmarshalJSON(data []byte) (err error) {
	...
	err = decoder.Decode(&varPeiUpdateInfo)
