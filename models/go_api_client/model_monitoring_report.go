...
type _MonitoringReport MonitoringReport
...
func (o *MonitoringReport) UnmarshalJSON(data []byte) (err error) {
	...
	varMonitoringReport := _MonitoringReport{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMonitoringReport)

	if err != nil {
		return err
	}

	*o = MonitoringReport(varMonitoringReport)
