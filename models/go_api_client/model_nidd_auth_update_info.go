...
type _NiddAuthUpdateInfo NiddAuthUpdateInfo
...
func (o *NiddAuthUpdateInfo) UnmarshalJSON(data []byte) (err error) {
	...
	varNiddAuthUpdateInfo := _NiddAuthUpdateInfo{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varNiddAuthUpdateInfo)

	if err != nil {
		return err
	}

	*o = NiddAuthUpdateInfo(varNiddAuthUpdateInfo)
