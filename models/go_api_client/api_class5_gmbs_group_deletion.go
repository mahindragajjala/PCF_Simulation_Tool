...
type ApiDelete5GMBSGroupRequest struct {
	ctx context.Context
	ApiService *Class5GMBSGroupDeletionAPIService
	extGroupId string
}
...
func (a *Class5GMBSGroupDeletionAPIService) Delete5GMBSGroupExecute(r ApiDelete5GMBSGroupRequest) (*http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "Class5GMBSGroupDeletionAPIService.Delete5GMBSGroup")
	if err != nil {
