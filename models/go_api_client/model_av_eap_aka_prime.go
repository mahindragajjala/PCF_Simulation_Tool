...
type AvEapAkaPrime struct {
	...
	CkPrime string `json:"ckPrime" validate:"regexp=^[A-Fa-f0-9]{32}$"`
	IkPrime string `json:"ikPrime" validate:"regexp=^[A-Fa-f0-9]{32}$"`
}
...
func (o *AvEapAkaPrime) UnmarshalJSON(data []byte) (err error) {
	...
	err = decoder.Decode(&varAvEapAkaPrime)
