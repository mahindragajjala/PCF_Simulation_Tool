...
type _NwdafRegistrationModification NwdafRegistrationModification
...
func (o *NwdafRegistrationModification) UnmarshalJSON(data []byte) (err error) {
	...
	varNwdafRegistrationModification := _NwdafRegistrationModification{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varNwdafRegistrationModification)

	if err != nil {
		return err
	}

	*o = NwdafRegistrationModification(varNwdafRegistrationModification)
