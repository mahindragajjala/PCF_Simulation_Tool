...
type _HssAuthenticationInfoResult HssAuthenticationInfoResult
...
func (o *HssAuthenticationInfoResult) UnmarshalJSON(data []byte) (err error) {
	...
	varHssAuthenticationInfoResult := _HssAuthenticationInfoResult{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varHssAuthenticationInfoResult)

	if err != nil {
		return err
	}

	*o = HssAuthenticationInfoResult(varHssAuthenticationInfoResult)
