...
type ApiModify5GVNGroupRequest struct {
	...
	ApiService *Class5GVNGroupModificationAPIService
	extGroupId string
	model5GVnGroupConfigurationModification *Model5GVnGroupConfigurationModification
	supportedFeatures *string
}

func (r ApiModify5GVNGroupRequest) Model5GVnGroupConfigurationModification(model5GVnGroupConfigurationModification Model5GVnGroupConfigurationModification) ApiModify5GVNGroupRequest {
	r.model5GVnGroupConfigurationModification = &model5GVnGroupConfigurationModification
	return r
}
...
func (a *Class5GVNGroupModificationAPIService) Modify5GVNGroupExecute(r ApiModify5GVNGroupRequest) (*PatchResult, *http.Response, error) {
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.model5GVnGroupConfigurationModification == nil {
		return localVarReturnValue, nil, reportError("model5GVnGroupConfigurationModification is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.model5GVnGroupConfigurationModification
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
