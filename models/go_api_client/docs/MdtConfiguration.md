...
**ReportAmountPerMeasurementLte** | Pointer to [**map[string]ReportAmountMdt**](ReportAmountMdt.md) | A map (list of key-value pairs) where MeasurementLteForMdt serves as key;  | [optional] 
**ReportAmountPerMeasurementNr** | Pointer to [**map[string]ReportAmountMdt**](ReportAmountMdt.md) | A map (list of key-value pairs) where MeasurementNrForMdt serves as key;  | [optional] 
...
### SetReportAmountPerMeasurementLte
