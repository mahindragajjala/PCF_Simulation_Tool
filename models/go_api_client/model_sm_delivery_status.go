...
type _SmDeliveryStatus SmDeliveryStatus
...
func (o *SmDeliveryStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varSmDeliveryStatus := _SmDeliveryStatus{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSmDeliveryStatus)

	if err != nil {
		return err
	}

	*o = SmDeliveryStatus(varSmDeliveryStatus)
