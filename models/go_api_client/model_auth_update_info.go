...
type _AuthUpdateInfo AuthUpdateInfo
...
func (o *AuthUpdateInfo) UnmarshalJSON(data []byte) (err error) {
	...
	varAuthUpdateInfo := _AuthUpdateInfo{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAuthUpdateInfo)

	if err != nil {
		return err
	}

	*o = AuthUpdateInfo(varAuthUpdateInfo)
