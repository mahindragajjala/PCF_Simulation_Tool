...
type _PdnConnectivityStatReport PdnConnectivityStatReport
...
func (o *PdnConnectivityStatReport) UnmarshalJSON(data []byte) (err error) {
	...
	varPdnConnectivityStatReport := _PdnConnectivityStatReport{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPdnConnectivityStatReport)

	if err != nil {
		return err
	}

	*o = PdnConnectivityStatReport(varPdnConnectivityStatReport)
